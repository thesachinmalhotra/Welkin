...
> **SUPERSEDED** — This plan has been superseded by the Composition Restoration program (Phase 4 / SAC-5). The certification test now runs as a native K8s Job via `scripts/certification/certify.sh`.
