...
Welkin is installed through the Timoni bundle at `timoni/bundles/welkin.bundle.cue`.
...
The deployment contract lives in `timoni/runtime/welkin.runtime.cue`.
...
```bash
timoni bundle apply \
  -f timoni/bundles/welkin.bundle.cue \
  -f timoni/runtime/welkin.runtime.cue \
