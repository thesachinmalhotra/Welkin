...
The release directory (`release/`) contains symlinks to the canonical CUE files:

```
release/
  welkin.bundle.cue    → timoni/bundles/welkin.bundle.cue
  welkin.runtime.cue   → timoni/runtime/welkin.runtime.cue
  collector.cue        → timoni/values/collector.cue
  openmeter.cue        → timoni/values/openmeter.cue
  postgres.cue         → timoni/values/postgres.cue
  minio.cue            → timoni/values/minio.cue
```
